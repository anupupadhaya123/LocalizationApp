...
public final class R {
  ...
  public static final class styleable {
     ...
     * <tr><td><code>{@link #ActivityFilter_activityAction net.puzzleleaf.dating_app:activityAction}</code></td><td>Action used for activity launch.</td></tr>
     * <tr><td><code>{@link #ActivityFilter_activityName net.puzzleleaf.dating_app:activityName}</code></td><td>Component name of the primary activity in the split.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name net.puzzleleaf.dating_app:activityAction
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name net.puzzleleaf.dating_app:activityName
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #ActivityRule_alwaysExpand net.puzzleleaf.dating_app:alwaysExpand}</code></td><td>Whether the activity should always be expanded on launch.</td></tr>
     * </table>
     ...
     * "<code>false</code>".
     *
     * @attr name net.puzzleleaf.dating_app:alwaysExpand
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #Capability_queryPatterns net.puzzleleaf.dating_app:queryPatterns}</code></td><td>Resource reference to the string array of query patterns for a custom capability.</td></tr>
     * <tr><td><code>{@link #Capability_shortcutMatchRequired net.puzzleleaf.dating_app:shortcutMatchRequired}</code></td><td>Indicates whether a parameter in a capability template can only contain a matched
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name net.puzzleleaf.dating_app:queryPatterns
     */
     ...
     * "<code>false</code>".
     *
     * @attr name net.puzzleleaf.dating_app:shortcutMatchRequired
     */
     ...
     * <tr><td><code>{@link #ColorStateListItem_alpha net.puzzleleaf.dating_app:alpha}</code></td><td>Alpha multiplier applied to the base color.</td></tr>
     * </table>
     ...
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name net.puzzleleaf.dating_app:alpha
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderAuthority net.puzzleleaf.dating_app:fontProviderAuthority}</code></td><td>The authority of the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderCerts net.puzzleleaf.dating_app:fontProviderCerts}</code></td><td>The sets of hashes for the certificates the provider should be signed with.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchStrategy net.puzzleleaf.dating_app:fontProviderFetchStrategy}</code></td><td>The strategy to be used when fetching font data from a font provider in XML layouts.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchTimeout net.puzzleleaf.dating_app:fontProviderFetchTimeout}</code></td><td>The length of the timeout during fetching.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderPackage net.puzzleleaf.dating_app:fontProviderPackage}</code></td><td>The package for the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderQuery net.puzzleleaf.dating_app:fontProviderQuery}</code></td><td>The query to be sent over to the provider.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderSystemFontFamily net.puzzleleaf.dating_app:fontProviderSystemFontFamily}</code></td><td>Provides the system font family name to check before downloading the font.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name net.puzzleleaf.dating_app:fontProviderAuthority
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name net.puzzleleaf.dating_app:fontProviderCerts
     */
     ...
     * </table>
     *
     * @attr name net.puzzleleaf.dating_app:fontProviderFetchStrategy
     */
     ...
     * </table>
     *
     * @attr name net.puzzleleaf.dating_app:fontProviderFetchTimeout
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name net.puzzleleaf.dating_app:fontProviderPackage
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name net.puzzleleaf.dating_app:fontProviderQuery
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name net.puzzleleaf.dating_app:fontProviderSystemFontFamily
     */
     ...
     * <tr><td><code>{@link #FontFamilyFont_font net.puzzleleaf.dating_app:font}</code></td><td>The reference to the font file to be used.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontStyle net.puzzleleaf.dating_app:fontStyle}</code></td><td>The style of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontVariationSettings net.puzzleleaf.dating_app:fontVariationSettings}</code></td><td>The variation settings to be applied to the font.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontWeight net.puzzleleaf.dating_app:fontWeight}</code></td><td>The weight of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_ttcIndex net.puzzleleaf.dating_app:ttcIndex}</code></td><td>The index of the font in the tcc font file.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name net.puzzleleaf.dating_app:font
     */
     ...
     * </table>
     *
     * @attr name net.puzzleleaf.dating_app:fontStyle
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name net.puzzleleaf.dating_app:fontVariationSettings
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name net.puzzleleaf.dating_app:fontWeight
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name net.puzzleleaf.dating_app:ttcIndex
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #SplitPairFilter_primaryActivityName net.puzzleleaf.dating_app:primaryActivityName}</code></td><td>Component name of the primary activity in the split.</td></tr>
     * <tr><td><code>{@link #SplitPairFilter_secondaryActivityAction net.puzzleleaf.dating_app:secondaryActivityAction}</code></td><td>Action used for secondary activity launch.</td></tr>
     * <tr><td><code>{@link #SplitPairFilter_secondaryActivityName net.puzzleleaf.dating_app:secondaryActivityName}</code></td><td>Component name of the secondary activity in the split.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name net.puzzleleaf.dating_app:primaryActivityName
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name net.puzzleleaf.dating_app:secondaryActivityAction
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name net.puzzleleaf.dating_app:secondaryActivityName
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #SplitPairRule_clearTop net.puzzleleaf.dating_app:clearTop}</code></td><td>If there is an existing split with the same primary container, indicates whether the
     * existing secondary container on top and all activities in it should be destroyed when a new
     * split is created using this rule.</td></tr>
     * <tr><td><code>{@link #SplitPairRule_finishPrimaryWithSecondary net.puzzleleaf.dating_app:finishPrimaryWithSecondary}</code></td><td>When all activities are finished in the secondary container, the activity in the
     * primary container that created the split should also be finished.</td></tr>
     * <tr><td><code>{@link #SplitPairRule_finishSecondaryWithPrimary net.puzzleleaf.dating_app:finishSecondaryWithPrimary}</code></td><td>When all activities are finished in the primary container, the activities in the
     * secondary container in the split should also be finished.</td></tr>
     * <tr><td><code>{@link #SplitPairRule_splitLayoutDirection net.puzzleleaf.dating_app:splitLayoutDirection}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPairRule_splitMinSmallestWidth net.puzzleleaf.dating_app:splitMinSmallestWidth}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPairRule_splitMinWidth net.puzzleleaf.dating_app:splitMinWidth}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPairRule_splitRatio net.puzzleleaf.dating_app:splitRatio}</code></td><td></td></tr>
     * </table>
     ...
     * "<code>false</code>".
     *
     * @attr name net.puzzleleaf.dating_app:clearTop
     */
     ...
     * "<code>false</code>".
     *
     * @attr name net.puzzleleaf.dating_app:finishPrimaryWithSecondary
     */
     ...
     * "<code>false</code>".
     *
     * @attr name net.puzzleleaf.dating_app:finishSecondaryWithPrimary
     */
    public static final int SplitPairRule_finishSecondaryWithPrimary=2;
    /**
     * <p>This symbol is the offset where the {@link net.puzzleleaf.dating_app.R.attr#splitLayoutDirection}
     ...
     * </table>
     *
     * @attr name net.puzzleleaf.dating_app:splitLayoutDirection
     */
    public static final int SplitPairRule_splitLayoutDirection=3;
    /**
     * <p>This symbol is the offset where the {@link net.puzzleleaf.dating_app.R.attr#splitMinSmallestWidth}
     * attribute's value can be found in the {@link #SplitPairRule} array.
     *
     * <p>May be a dimension value, which is a floating point number appended with a
     * unit such as "<code>14.5sp</code>".
     ...
     * mm (millimeters).
     *
     * @attr name net.puzzleleaf.dating_app:splitMinSmallestWidth
     */
    public static final int SplitPairRule_splitMinSmallestWidth=4;
    /**
     * <p>This symbol is the offset where the {@link net.puzzleleaf.dating_app.R.attr#splitMinWidth}
     * attribute's value can be found in the {@link #SplitPairRule} array.
     *
     * <p>May be a dimension value, which is a floating point number appended with a
     * unit such as "<code>14.5sp</code>".
     ...
     * mm (millimeters).
     *
     * @attr name net.puzzleleaf.dating_app:splitMinWidth
     */
    public static final int SplitPairRule_splitMinWidth=5;
    /**
     * <p>This symbol is the offset where the {@link net.puzzleleaf.dating_app.R.attr#splitRatio}
     * attribute's value can be found in the {@link #SplitPairRule} array.
     *
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name net.puzzleleaf.dating_app:splitRatio
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #SplitPlaceholderRule_placeholderActivityName net.puzzleleaf.dating_app:placeholderActivityName}</code></td><td>Component name of the placeholder activity in the split.</td></tr>
     * <tr><td><code>{@link #SplitPlaceholderRule_splitLayoutDirection net.puzzleleaf.dating_app:splitLayoutDirection}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPlaceholderRule_splitMinSmallestWidth net.puzzleleaf.dating_app:splitMinSmallestWidth}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPlaceholderRule_splitMinWidth net.puzzleleaf.dating_app:splitMinWidth}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPlaceholderRule_splitRatio net.puzzleleaf.dating_app:splitRatio}</code></td><td></td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name net.puzzleleaf.dating_app:placeholderActivityName
     */
